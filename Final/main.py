...
#model_age = load_model('D:/Kuliah/Big Data Challenge/Final/FInalBDC/Model_48_1_age.hdf5',compile=False)
model_age = load_model('D:/Kuliah/Big Data Challenge/Final/FInalBDC/6.hdf5',compile=False)
model_gender = load_model('D:/Kuliah/Big Data Challenge/Final/FInalBDC/model_48_gender.hdf5',compile=False)
...
def classify_age(im):
    ...
    for face_location in face_locations:
        ...
        age7 = model_age.predict(face_roi)[0][0]
        # face_age = str(round((age1+age2+age3+age4+age5+age6+age7)/7))
        face_age = str(round(age7))
...
#out = cv2.VideoWriter('output.mp4', -1,8, (1080,1920))
...
while(video.isOpened()):
    ...
    #out.write(frame[:, :, ::-1])
    #frame = cv2.resize(age, (0, 0), fx=1, fy=1)
